...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public class ManipulationHandlerInspector : UnityEditor.Editor
    {
        ...
        private SerializedProperty worldAnchor;
        private SerializedProperty MRTK_Standard;
        ...
        public void OnEnable()
        {
            ...
            // Aggiunto da noi
            worldAnchor = serializedObject.FindProperty("wordAnchorManager");
            MRTK_Standard = serializedObject.FindProperty("MRTK_Standard_Lime");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(MRTK_Standard);
