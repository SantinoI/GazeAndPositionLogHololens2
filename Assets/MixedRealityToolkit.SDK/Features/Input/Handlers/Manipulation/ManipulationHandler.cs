...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    {
        //public AnchorScript rilasciaAncora;
        ...
        [SerializeField]
        [Tooltip("Aggiungi il WorldAnchorManager")]
        public WorldAnchorManager wordAnchorManager;

        [SerializeField]
        [Tooltip("Aggiungi il WorldAnchorManager")]
        public Material MRTK_Standard_Lime;
        ...
        {
            wordAnchorManager.AttachAnchor(this.gameObject);
            var octa = GameObject.Find("real_puntatore");
            //octa.GetComponent<Renderer>().material.color = Color.yellow;

            //this.gameObject.GetComponent<Renderer>().material.color = Color.yellow;
            octa.GetComponent<Renderer>().material.color = Color.red;
            
        }

        public void ReleaseAnchor()
        {
            Debug.Log("Manipolazione");
            wordAnchorManager.RemoveAnchor(this.gameObject);
            var octa = GameObject.Find("real_puntatore");

            octa.GetComponent<Renderer>().material = MRTK_Standard_Lime;
